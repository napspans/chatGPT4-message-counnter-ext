! function (t) {
  ...
  s.m = t, s.c = e, s.d = function (t, e, i) {
    ...
    if (s.r(i), Object.defineProperty(i, "default", {
      ...
      for (var l in t) s.d(i, l, function (e) {
        return t[e]
      }.bind(null, l));
    return i
  }, s.n = function (t) {
  ...
  window.addEventListener("DOMContentLoaded", (function () {
    ...
    //吹き出し表示条件
    // セッション回数をlocalStorageから取得（なければ0を設定）
    let sessionCount = localStorage.getItem("sessionCount") || 0;
    sessionCount = parseInt(sessionCount, 10) + 1; // セッション回数を+1
    localStorage.setItem("sessionCount", sessionCount); // 更新されたセッション回数を保存
    ...
    if (sessionCount === 1 || sessionCount % 5 === 0) {
      ...
      setTimeout(() => {
        if (s.dataset.message && "" !== s.dataset.message) {
          o.style.opacity = "1";
    ...
    let r = 0;
    e.onclick = function () {
      r || (a.src = "https://www.buymeacoffee.com/widget/page/" + s.dataset.id + "?description=" + encodeURIComponent(s.dataset.description) + "&color=" + encodeURIComponent(s.dataset.color)), r++, o.style.transform = "scale(0.7)", o.style.opacity = "0", o.style.transition = ".25s ease all", o.style.visibility = "hidden", l.style.width = "100%", l.style.height = "100%", a.style.width = "420px", a.style.height = `${window.innerHeight-120}px`, a.style.transform = "scale(1)", a.style.opacity = "1", t.matches || setTimeout((function () {
        n.style.visibility = "visible"
      }), 150), e.style.transform = "scale(1)", e.style.transition = ".25s ease all", e.innerHTML = '<svg style="width: 16px;height:16px;" width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.1133 0L8 6.11331L1.88669 0L0 1.88663L8 9.88663L16 1.88663L14.1133 0Z" fill="white"/></svg>'
      ...
      l.style.width = "0", l.style.height = "0", a.style.height = "0", a.style.opacity = "0", e.style.transform = "scale(1)", e.style.transition = ".25s ease all", a.style.transform = "scale(0)", t.matches || (n.style.visibility = "hidden", setTimeout((function () {}), 100)), e.innerHTML = '<img src="https://cdn.buymeacoffee.com/widget/assets/coffee%20cup.svg" alt="Buy Me A Coffee" style="height: 36px; width: 36px; margin: 0; padding: 0;">'
    ...
    y.includes("visited") || "" == s.dataset.message ? (o.style.transform = "scale(0.7)", o.style.opacity = "0", o.style.transition = ".25s ease all", o.style.visibility = "hidden") : (document.cookie = `visited=1${c};path=/`, setTimeout(() => {
